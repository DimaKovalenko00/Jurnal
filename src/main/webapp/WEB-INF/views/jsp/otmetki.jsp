...
<nav class="two">
    <ul>
        <li><a href="/add/newotmetka"><i class="fa fa-home fa-fw"></i>добавление</a></li>
        <li><input class="button"  type="submit" value="Отметки"/></li>
    </ul>
</nav>
<div class="rab">
<table   width="850px"  cellspacing="0" cellpadding="5" border="2" align="center">
        ...
        <c:forEach items="${otmetki}" var="o">
            <tr>
                <td>${o.otmetka}</td>
                <td>${o.data_otmetky}</td>
            </tr>
        </c:forEach>
