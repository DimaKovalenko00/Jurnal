...
<body >
<div id="header">
    <div id="title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">CTO </font></font></div>
</div>
<div class="dropdown">
    ...
    <div class="dropdown-child">
        <div id="navigation">
            ...
            <ul>
                <li id="linkHome"><a href="/cars">просмотр список авто</a><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"></font></font></a></li>
...
<div class="navr" >
    ...
    <div class="rab">
       ...
       <h3>
           Добро пожаловать в приложение для СТО
       </h3>
    </div>
</body>
</html>