...
<form method="POST" action="predmet/otmetki">
    <nav class="two">
        <ul>
            <li><a href="predmeti/new"><i class="fa fa-home fa-fw"></i>добавление</a></li>
            <li><input class="button"  type="submit" value="otmetki"/></li>
        </ul>
    </nav>
    <div class="rab">
        <table   width="850"  cellspacing="0" cellpadding="5" border="2" align="center">
            <tr>
                <th>предмет</th>
            </tr>
            ...
            <c:forEach items="${predmeti}" var="p">
                <tr>
                    ...
                    <td><input type="radio" name="id" value="${p.nazv_predmeta_id}"/></td>
                </tr>
            </c:forEach>
        </table>
    </div>
